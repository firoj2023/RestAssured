...
import request_repository.get_request_repositroy;
...
@Test
	public static void orchestrator() throws IOException
	{
		...
		String baseuri = get_request_repositroy.baseuri();
		String resource = get_request_repositroy.resource();
		
		for (int i=0; i<5; i++)
		{
			responseStatuscode = common_method_get_api.responsestatus_extractor(baseuri, resource);
			if (responseStatuscode == 200)
			{
				responseBody = common_method_get_api.reponsebody_extractor(baseuri, resource);
